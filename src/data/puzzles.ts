...
export const PUZZLES_DEF: PuzzleDef[] = [
  ...
  { id: 13, type: 'faraones',  afterEvent: 14, pharaohPeriod: 'medio',   statKeys: ['cultura', 'influencia'], penalty: 3 },
  { id: 14, type: 'faraones',  afterEvent: 22, pharaohPeriod: 'nuevo',   statKeys: ['cultura', 'influencia'], penalty: 3 },
  { id: 15, type: 'faraones',  afterEvent: 30, pharaohPeriod: 'tardio',  statKeys: ['cultura', 'influencia'], penalty: 3 },
]
